...
/**
 * Servlet implementation class ShowNhanVienToUpdate
 */
@WebServlet("/ShowNhanVienToUpdate")
public class ShowNhanVienToUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowNhanVienToUpdate() {
        super();
